function [data_x, target_y] = initPatientSpecific(recording)
% This function returns a training data set comprised of (1) the common
% data set which with is a non-patient specific set of each different
% type of heartbeat and (2) the first 5-minutes of patient specific
% heartbeat data specific by the recording file. 
%
...
% Read in first 5 minutes of specified recording
